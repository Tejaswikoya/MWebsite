...
client = pymongo.MongoClient(
    "mongodb+srv://admin:admin123@cluster0.0uzzzz2.mongodb.net/?retryWrites=true&w=majority")
db = client['mydb']
currentUser = ""
...
def showPage():
    if request.method == 'GET':
        ...
        if 'form4' in res:
            ...
            f4 = 'not filled'
        return render_template('usersPage.html', f1=f1, f2=f2, f3=f3, f4=f4, data=res)
